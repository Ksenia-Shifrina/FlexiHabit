...
const seeds = [
  {
    ...
    days: [
      ...
      { date: new Date('2024-04-09'), target: true, completed: false },
      { date: new Date('2024-04-12'), target: true, completed: false },
      { date: new Date('2024-04-13'), target: true, completed: false },
      { date: new Date('2024-04-14'), target: true, completed: false },
    ],
  },
  {
    ...
    days: [
      ...
      { date: new Date('2024-04-08'), target: true, completed: true },
      { date: new Date('2024-04-11'), target: true, completed: false },
      { date: new Date('2024-04-14'), target: true, completed: false },
    ],
  },
];
